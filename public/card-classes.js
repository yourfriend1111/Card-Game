...
const allCards = [
    ...
    new MeleeCard("Ironbound Warrior", 5, 5, 3, 3, 1,"'For every piece of equipment this card gets, it give +1/0/1. Ignore Equipment limit for this card", ""),
    new MeleeCard("Bladeclash Soldier", 4, 10, 5, 4, 1, "If this troop has been damaged +3 dmg", ""),
    new MeleeCard("Static Warden", 5, 3, 2, 3, 1, "Add 1/0/1 for each energy used from the previous turn. Gain 1 speed for every 3 energy spent (Rounded down)", ""),
    ...
    new MeleeCard("Crimson Heart", 4, 7, 3, 4, 1, "On summon give all '+1/0/0 to all infatry troops including itself. Suicide - Discard this card +1/0/1 to all troops", ""),
    new MeleeCard("Siegebreaker", 5, 10, 2, 5, 1, "Can one tap all enemy buildings", ""),
    new MeleeCard("Fleshstringed Goblin", 6, 4, 4, 4, 1, "For every troop discarded on your side +1/0/1", ""),
    ...
    new FlyingCard("Winged Phantom", 5, 1, 7, 6, 1, "This creature has a 4/7 chance to dodge incoming attacks", ""),
    ...
    new FlyingCard("Golden Gale", 8, 14, 0, 4, 1, "+2 Energy each round the dragon doesn't move", ""),
    new FlyingCard("Lifebreath Serpant", 9, 11, 5, 5, 1, "Reserect 1 Flying unit with cost 6 or less. After attacking, heal 2 hp", ""),
    new FlyingCard("Wise Fang", 10, 11, 8, 5, 1, "Can copy one ally air troops abilitys (can be different each turn). (cant be an elite)", ""),
